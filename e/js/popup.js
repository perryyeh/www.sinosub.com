...
Popup.prototype = {
    ...
    build: function() {
        ...
        var close = '<input type="button" value=" " id="dialogBoxClose"  width="16" height="16" align="absmiddle" title="关闭"/>';
        ...
        if (this.config.isHaveTitle) {
            mainBox += '<tr height="24" bgcolor="' + this.color.tColor + '"><td><table id="dialogHead" style="-moz-user-select:none;height:24px;" width="100%" border="0" cellpadding="0" cellspacing="0" ><tr><td width="6" height="24"></td><td id="dialogBoxTitle" style="font-weight:bold;text-align:left">' + this.info.title + '&nbsp;</td><td id="dialogClose" width="20" align="right" valign="middle">' + close + '</td><td width="6"></td></tr></table></td></tr>'
        } else {
...
//通过popup.js打开模态对话框
var popp;
function ShowIframe(t,url, w, h,scroll) //显示有滚动条的iframe,scroll只有yes和no
{
    var pop = new Popup({
        contentType: 1,
        scrollType: scroll,
...
function ShowAlert(title,content,w,h) //显示警示对话框
{
    alert(1);
    var pop = new Popup({
        contentType: 4,
...
function ShowAlertAndRedirect(title,content,target,w,h) //显示警示对话框
{
    var pop = new Popup({
        contentType: 4,
        isReloadOnClose: false,
